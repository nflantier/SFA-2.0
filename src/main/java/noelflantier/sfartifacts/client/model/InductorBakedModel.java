...
import noelflantier.sfartifacts.common.blocks.BakedModelBlock;

public class InductorBakedModel implements IBakedModel {

    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(Ressources.MODID + ":"+Ressources.UL_NAME_INDUCTOR);

    private TextureAtlasSprite sprite;
    private VertexFormat format;

    public InductorBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        this.format = format;
        sprite = bakedTextureGetter.apply(new ResourceLocation(Ressources.MODID, "blocks/isbmtexture"));
    }
