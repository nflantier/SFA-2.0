...
public abstract class EntityAITargetSFA extends EntityAIBase
{
    ...
    public EntityAITargetSFA(EntityLiving p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntityAITargetSFA(EntityLiving p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
    ...
    protected boolean isSuitableTarget(EntityLivingBase p_75296_1_, boolean p_75296_2_)
    {
        ...
        else
        {
            ...
            {
                if (p_75296_1_ instanceof IEntityOwnable && ((IEntityOwnable)this.taskOwner).getOwnerId().equals(((IEntityOwnable)p_75296_1_).getOwnerId()))
                {
                    return false;
                }
            ...
            if ( this.taskOwner instanceof EntityCreature && !((EntityCreature) this.taskOwner).isWithinHomeDistanceFromPosition(new BlockPos(MathHelper.floor_double(p_75296_1_.posX), MathHelper.floor_double(p_75296_1_.posY), MathHelper.floor_double(p_75296_1_.posZ))))
            {
                return false;
            }
    ...
    private boolean canEasilyReach(EntityLivingBase p_75295_1_)
    {
        ...
        Path pathentity = this.taskOwner.getNavigator().getPathToEntityLiving(p_75295_1_);
